...
## Тексты ошибок перевода часов (DST)
...
Остальные `kind` сохраняют ранее заданные тексты (формат/пример, прошлое, горизонт, пустой текст, длина, несуществующая дата).
